        ...
        sidebarLayout(
                sidebarPanel(
                        ...
                        h6("The script generate a log file on each server. 
                           ...
                           githup repository associated with this project (right clic on the link -> save link ...): ", a("Input.zip",href="http://github.com/coursera1/DDP-Project/raw/master/Input.zip")),
                        h6("Now, just clic the 'Choose file' and select the 'Input.zip' file you've just downloaded."),
                        h6("Once this done, you can play around with graph tunithe ng widgets to select the date range, the x axis tick or the y axis limit and see the results on the graph."),
                        h5("Graph"),
                        ...
                        h6("You can optionnaly upload another file that contains a series of time-events associations that will be plotted
                           as vertical lines on the graph. You can find an example here (right clic on the link -> save link  ...): ", a("Events.cvs",href="http://github.com/coursera1/DDP-Project/raw/master/Events.csv")),
                        h5("Table views"),
